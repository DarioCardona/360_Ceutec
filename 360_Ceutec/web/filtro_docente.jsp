<%-- 
    Document   : filtro_docente
    Created on : 12-18-2017, 10:50:34 AM
    ...
    <body>
        ...
        <div>
            <!--*********************  Filter start  *********************-->
                ...
                <form action="tablaUsuario.jsp " methor="POST">
                   <div class="left">Filtrado por: 
                    ...
                    <table class="no-space" id="PerformanceTable" width="100%" align="center" >
                        <thead class="mytable col-md-12">
                            <tr class="col-md-12">
                                
                                <th class="col-md-4 centered">
